...
<summary>Afficher la réponse</summary>
A read-only template with instructions for creating a container (1 period)
...
<summary>Afficher la réponse</summary>
GitHub is a cloud-based service platform for the development of software and version control using Git (1 point). The main The difference is that Git is a local versioning tool, while GitHub Provides a web interface and social features to manage repositories Git online. (1 point)
